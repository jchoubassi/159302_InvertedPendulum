...
//X vs. X_DOT
   ...
   fl->rules[25+14].out_fuzzy_set = out_ps;
...
fl->inp_mem_fns[in_x][in_nl] = init_trapz(-4.0, -4.0, -3.5, -2.5, left_trapezoid); 
fl->inp_mem_fns[in_x][in_ns] = init_trapz(-3.0, -2.0, -1.5, 0.0, regular_trapezoid);  
fl->inp_mem_fns[in_x][in_ze] = init_trapz(-0.5, 0, 0, 0.5, regular_trapezoid);        
fl->inp_mem_fns[in_x][in_ps] = init_trapz(0.0, 1.5, 2.0, 3.0, regular_trapezoid);     
fl->inp_mem_fns[in_x][in_pl] = init_trapz(2.5, 3.5, 4.0, 4.0, right_trapezoid);  
	
   /* The X dot membership functions */
   //enter the appropriate membership function initialisations here 
fl->inp_mem_fns[in_x_dot][in_nl] = init_trapz(-4.0, -4.0, -3.5, -2.5, left_trapezoid); 
fl->inp_mem_fns[in_x_dot][in_ns] = init_trapz(-3.0, -2.0, -1.5, 0.0, regular_trapezoid);  
fl->inp_mem_fns[in_x_dot][in_ze] = init_trapz(-0.5, 0, 0, 0.5, regular_trapezoid);        
fl->inp_mem_fns[in_x_dot][in_ps] = init_trapz(0.0, 1.5, 2.0, 3.0, regular_trapezoid);     
fl->inp_mem_fns[in_x_dot][in_pl] = init_trapz(2.5, 3.5, 4.0, 4.0, right_trapezoid); 


   /* The theta membership functions */
   //enter the appropriate membership function initialisations here
fl->inp_mem_fns[in_theta][in_nl] = init_trapz(-4.0, -4.0, -3.5, -2.5, left_trapezoid); 
fl->inp_mem_fns[in_theta][in_ns] = init_trapz(-3.0, -2.0, -1.5, 0.0, regular_trapezoid);  
fl->inp_mem_fns[in_theta][in_ze] = init_trapz(-0.5, 0, 0, 0.5, regular_trapezoid);        
fl->inp_mem_fns[in_theta][in_ps] = init_trapz(0.0, 1.5, 2.0, 3.0, regular_trapezoid);     
fl->inp_mem_fns[in_theta][in_pl] = init_trapz(2.5, 3.5, 4.0, 4.0, right_trapezoid); 
  	
   /* The theta dot membership functions */
   //enter the appropriate membership function initialisations here
fl->inp_mem_fns[in_theta_dot][in_nl] = init_trapz(-4.0, -4.0, -3.5, -2.5, left_trapezoid); 
fl->inp_mem_fns[in_theta_dot][in_ns] = init_trapz(-3.0, -2.0, -1.5, 0.0, regular_trapezoid);  
fl->inp_mem_fns[in_theta_dot][in_ze] = init_trapz(-0.5, 0, 0, 0.5, regular_trapezoid);        
fl->inp_mem_fns[in_theta_dot][in_ps] = init_trapz(0.0, 1.5, 2.0, 3.0, regular_trapezoid);     
fl->inp_mem_fns[in_theta_dot][in_pl] = init_trapz(2.5, 3.5, 4.0, 4.0, right_trapezoid); 
...
void initFuzzySystem (fuzzy_system_rec *fl) {
   ...
   fl->output_values[out_nl]  = -89.0;  
   fl->output_values[out_ns]  = -51.0;   
   fl->output_values[out_ze]  =  0.0;    
   fl->output_values[out_ps]  =  60.0;   
   fl->output_values[out_pl]  =  90.0;  
